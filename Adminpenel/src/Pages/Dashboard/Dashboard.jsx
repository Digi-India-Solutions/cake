...
const Dashboard = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const tagsResponse = await axios.get(
          "http://localhost:5000/api/get-tags"
        );
        setTags(tagsResponse.data.data);

        // Fetch vouchers
        // const vouchersResponse = await axios.get('http://localhost:5000/api/vouchers');
  ...
  //       const salesResponse = await axios.get('http://localhost:5000/api/day-sales');
